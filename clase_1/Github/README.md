...
5. Recibir invitación del repo https://github.com/ccsuehara/letras_ago2026 y haber aceptado.
...
General:
- Por qué nos importa el control de versiones y qué problemas resuelve. 
...
### Git 
Git es una sistema de control de versiones de código abierto. Utilizado principalmente para monitorear cambios en los archivos de texto. Nos brinda las siguientes características principales: 

- Control de versiones: Múltiples fotos del proyecto a través del tiempo.  
- Distribuido y descentralizado: Colaboradores pueden trabajar independientemente pues todos tienen la historia completa,
sin embargo, pueden trabajar en sintonía ya que Git se encarga de "compatibilizar" las contribuciones.

### Github 
GitHub es la implementación de Git más popular. Es básicamente un servicio web. 
...
Los conceptos que manejaremos hoy son: 
...
4. Aparecerá el siguiente cuadro, acepta. 
...
Adicional:   
Los archivos suelen tener tres estados:   
- Directorio de de trabajo. 
- Staging area o git staged area es un espacio temporal de trabajo donde se seleccionan los cambios antes de hacerles commit. En términos prácticos, Github Desktop manda al staging area a los archivos seleccionados en el panel izquierdo.
- Repositorio 
...
- Los branches(ramas) son vitales en Git. Adicional al control de versiones, facilita la colaborción.  
...
Haz la prueba de cambiar la rama, en https://github.com/ccsuehara/letras_ago2026, ¿cambia acaso el contenido? 
...
- Ve a https://github.com/ccsuehara/letras_ago2026, y dale click al botón que dice (símbolo branch) main. **Asegúrate que sea el main!!!**
...
- Ve a https://github.com/ccsuehara/letras_ago2026/pulls y dale click a *New pull request*
